...
outreg2 using Table4.doc, replace dec(3) ctitle(OLS) keep(divorced got_members lost_members got_retired got_job lost_job) addtext(Controls, NO, Data, 1994+, Expectation, NA)
...
*Table 4
outreg2 using Table4.doc, append dec(3) ctitle(OLS) keep(divorced got_members lost_members got_job lost_job got_retired ) addtext(Controls, YES, Data, 1994+, Expectation, NA)
...
*Table 4
outreg2 using Table4.doc, append dec(3) ctitle(OLS) keep(exp_home_price_lag exp_1y_mortgage_lag divorced got_members lost_members got_job lost_job got_retired) addtext(Controls, YES, Data, 2005+, Expectation, NA)
*Table 5 - Frictions
...
outreg2 using Table4.doc, append dec(3) ctitle(OLS) keep(divorced got_members lost_members got_retired got_job lost_job) addtext(Controls, YES, Data, 2005+, Expectation, NA)
...
outreg2 using Table7.doc, replace dec(3) ctitle(OLS) keep(exp_home_price_point_w exp_1y_mortgage_rate_w percieved_mortgage_rate_w divorced got_members lost_members got_job lost_job got_retired)  addtext(Additional Controls, YES,  Winsorized, YES, Type of Expectation, Point, Dataset, Full)
...
outreg2 using Table7.doc, append ctitle(2SLS) keep(exp_home_price_point_w exp_1y_mortgage_rate_w percieved_mortgage_rate_w divorced got_members lost_members got_job lost_job got_retired) addtext(Additional Controls, YES,  Winsorized, YES, Type of Expectation, Point, Dataset, Full)
...
outreg2 using Table7.doc, append ctitle(ORIV) keep(exp_home_price_point_w exp_1y_mortgage_rate_w percieved_mortgage_rate_w divorced got_members lost_members got_job lost_job got_retired) addtext(Additional Controls, YES,  Winsorized, YES, Type of Expectation, Both,  Dataset, Full)

*Reduced sample
drop if missing(buyer)
ivregress 2sls sale_prob (exp_home_price_point_w = home_price_instrument) exp_1y_mortgage_rate_w percieved_mortgage_rate_w age male race married retired student some_college college i.income_cat i.date i.region divorced got_members lost_members got_retired got_job lost_job, cluster(userid) nocons
outreg2 using Table7.doc, append dec(3)  ctitle(ORIV) keep(exp_home_price_point_w exp_1y_mortgage_rate_w percieved_mortgage_rate_w divorced got_members lost_members got_job lost_job got_retired) addtext(Additional Controls, YES,  Winsorized, YES, Type of Expectation, Both,  Dataset, Reduced)

*Only buyers
keep if buyer ==1
ivregress 2sls sale_prob (exp_home_price_point_w = home_price_instrument) exp_1y_mortgage_rate_w percieved_mortgage_rate_w age male race married retired student some_college college i.income_cat i.date i.region divorced got_members lost_members got_retired got_job lost_job, cluster(userid) nocons
outreg2 using Table7.doc, append dec(3) ctitle(ORIV) keep(exp_home_price_point_w exp_1y_mortgage_rate_w percieved_mortgage_rate_w divorced got_members lost_members got_job lost_job got_retired) addtext(Additional Controls, YES,  Winsorized, YES, Type of Expectation, Both,  Dataset, Buyers)

*Only renters
use oriv, clear
keep if renter == 1
ivregress 2sls sale_prob (exp_home_price_point_w = home_price_instrument) exp_1y_mortgage_rate_w percieved_mortgage_rate_w age male race married retired student some_college college i.income_cat i.date i.region divorced got_members lost_members got_retired got_job lost_job, cluster(userid) nocons
outreg2 using Table7.doc, append dec(3)  ctitle(ORIV) keep(exp_home_price_point_w exp_1y_mortgage_rate_w percieved_mortgage_rate_w divorced got_members lost_members got_job lost_job got_retired) addtext(Additional Controls, YES,  Winsorized, YES, Type of Expectation, Both,  Dataset, Renters)
